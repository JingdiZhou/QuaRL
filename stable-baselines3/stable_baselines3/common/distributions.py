...
class DiagGaussianDistribution(Distribution):
    ...
    def proba_distribution_net(self, quantized: int, latent_dim: int, log_std_init: float = 0.0) -> Tuple[nn.Module, nn.Parameter]:
        """
...
class CategoricalDistribution(Distribution):
    ...
    def proba_distribution_net(self, quantized:int, latent_dim: int) -> nn.Module:
        """
...
class StateDependentNoiseDistribution(Distribution):
    ...
    def proba_distribution_net(
        self, quantized: int, latent_dim: int, log_std_init: float = -2.0, latent_sde_dim: Optional[int] = None
