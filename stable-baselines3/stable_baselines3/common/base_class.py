        ...
        for name in params:
            ...
            if isinstance(attr, th.optim.Optimizer):
                ...
                # the user has provided a sensible state dictionary.
                    attr.load_state_dict(params[name])  # type: ignore[arg-type]  # if mode == "train" ,which means it need load optimzier
                else: # no need to load optimizer
                    pass
            else:
    ...
    def load(  # noqa: C901
        ...
        **kwargs,
        ...
        try:
            ...
            model.set_parameters(params, exact_match=True, device=device, mode = "eval")
