...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            rollout = self.collect_rollouts(   #update target network
                self.env,
                train_freq=self.train_freq,
            ...
            if self.num_timesteps > 0 and self.num_timesteps > self.learning_starts: # self.learning_starts == 100, which means after collecting 100 steps(data) q_net shall start to train
                # If no `gradient_steps` is specified,
                # do as many gradients steps as steps performed during the rollout
                #gradient_step means after the specific steps the target network will be updated
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            for idx, done in enumerate(dones):
                if done:
                    ...
                    self._episode_num += 1  # episode add 1 when the game ends
