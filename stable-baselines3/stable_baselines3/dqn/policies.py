...
class DQNPolicy(BasePolicy):
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        # self.optimizer = SAM(model.parameters(), th.optim.SGD, rho=step_size, adaptive=adaptive, lr=lr, momentum=momentum, weight_decay=weight_decay)
