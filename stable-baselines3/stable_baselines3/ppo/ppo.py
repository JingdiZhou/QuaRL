...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        self.q = quantized  # quantization bit
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.optimize_choice == "HERO":
                    ...
                    loss_grads = []
                    for index_param, param in enumerate(self.policy.mlp_extractor.parameters()):
                    ...
                    loss_new = policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss
